...
const urlStruct = {
  GET: {
    ...
    '/resources/bootstrap/bootstrap.min.css': htmlHandler.getBootstrapCss,
    '/resources/babel/browser.min.js': htmlHandler.getBabelJs,
    '/resources/jquery/slim.min.js': htmlHandler.getJQueryJs,
    '/resources/ajax/popper.min.js': htmlHandler.getAjaxJs,
    '/resources/bootstrap/bundle.min.js': htmlHandler.getBootstrapJs,
    '/src/toastNotifications.js': htmlHandler.getToastNotificationsJs,
